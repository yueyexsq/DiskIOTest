...
void RandPosInRadius(float centerX, float centerY, int radius, float& x, float& y, int radius_precision=1);
void RandPosInRec(float centerX, float centerY, int width, int height, float& x, float& y);
