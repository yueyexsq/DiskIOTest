...
class MANGOS_DLL_DECL Grid
{
    ...
    public:
        ...
        */
        ...
        /** Return the number of own object within the grid.
         */
        template<class SPECIFIC_OBJECT> unsigned int SelfObjectsInGrid(void) const { return i_objects.template Count<SPECIFIC_OBJECT>(); } 
